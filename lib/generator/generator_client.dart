...
extension GeneratorClient on DBusGeneratorHandler {
  void buildClientHelper() {
    ...
    buffer.writeln('// =========================');
    buffer.writeln('class ${classInfo.className}_Client extends DBusClientHelper implements ${classInfo.className} {');
    buffer.writeln('${classInfo.className}_Client(super.remoteObject) : super(interfaceName: ${classInfo.className}_InterfaceName);');
